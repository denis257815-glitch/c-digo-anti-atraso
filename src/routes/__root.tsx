...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/JATERzy4vZh4A3fj8uLogPTbSBx1/social-images/social-1778474476105-og-image.webp" },
      ...
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/JATERzy4vZh4A3fj8uLogPTbSBx1/social-images/social-1778474476105-og-image.webp" },
...
function RootComponent() {
  useEffect(() => {
    ...
    // Registra o SW silenciosamente. A nova versão fica em "waiting" e
    // assume sozinha na próxima vez que o app for aberto — sem reloads
    // automáticos enquanto o usuário está usando.
