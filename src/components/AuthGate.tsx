  ...
  return (
    <div className="relative flex min-h-[100dvh] items-end justify-center overflow-hidden bg-black px-5 pb-8 pt-10">
      <img
        ...
        alt=""
        aria-hidden
        className="pointer-events-none absolute inset-0 h-full w-full object-cover object-[50%_82%] grayscale contrast-110 sm:object-[50%_85%] md:object-[50%_88%] lg:object-[50%_90%] xl:object-[50%_92%]"
      />
