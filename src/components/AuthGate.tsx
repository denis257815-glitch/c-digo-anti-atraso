  ...
  return (
    <div className="relative flex min-h-[100dvh] items-end justify-center overflow-hidden bg-black px-5 pb-8 pt-10">
      <img
        ...
        alt=""
        aria-hidden
        className="pointer-events-none absolute left-1/2 top-0 h-[80%] w-auto max-w-none -translate-x-1/2 object-cover object-center grayscale contrast-110 md:left-0 md:w-full md:translate-x-0"
      />
